...
- [Basics](basics.html): start here. Twenty small demos, one library idea each — the 3D coordinate
...
The twenty ideas, in the order the page presents them:
...
node scripts/check-basics.mjs [port]   # the basics tour: twenty demos, every control, every assertion
