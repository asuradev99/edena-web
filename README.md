...
- [Basics](basics.html): start here. Twenty-two small demos, one library idea each — the 3D coordinate
...
The twenty-two ideas, in the order the page presents them:
...
node scripts/check-basics.mjs [port]   # the basics tour: twenty-two demos, every control, every assertion
